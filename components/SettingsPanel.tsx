...
import { X, Volume2, VolumeX, Shield, Trash2, Settings, MessageSquare, Ear, Download, Gauge, Sun, Moon } from "lucide-react";
        ...
        <>
          ...
          >
            ...
            <div className="flex-1 overflow-y-auto px-5 py-4 space-y-6">
              {/* Theme Section */}
              <div>
                <h3 className="text-[10px] font-semibold uppercase tracking-wider px-1 mb-3" style={{ color: "var(--text-dim)" }}>
                  Appearance
                </h3>
                <button
                  onClick={toggleTheme}
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div className="text-left">
                      <p className="text-sm" style={{ color: "var(--foreground)" }}>Theme</p>
              ...
              <div>
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div className="text-left">
                      <p className="text-sm" style={{ color: "var(--foreground)" }}>Laila&apos;s Voice</p>
                      <p className="text-xs" style={{ color: "var(--text-muted)" }}>
              ...
              {voiceEnabled && (
                ...
                >
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <p className="text-sm" style={{ color: "var(--foreground)" }}>Voice Speed</p>
              ...
              <div>
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div className="text-left">
                      <p className="text-sm" style={{ color: "var(--foreground)" }}>Say &quot;Laila&quot;</p>
                      <p className="text-xs" style={{ color: "var(--text-muted)" }}>
                  ...
                  {allowedTypes.size === 0 ? (
                    ...
                    >
                      <div className="flex items-center gap-2">
                        ...
                        <p className="text-sm" style={{ color: "var(--text-muted)" }}>No permissions granted yet</p>
                      </div>
                    </div>
                  ) : (
                    <>
                      {Array.from(allowedTypes).map((type) => (
                        ...
                        >
                          ...
                          <p className="text-sm" style={{ color: "var(--foreground)" }}>{typeLabels[type] || type}</p>
                ...
                <div className="space-y-2">
                  <div className="flex gap-2">
                    <button
                      ...
                      className="flex-1 flex items-center justify-center gap-2 rounded-xl px-4 py-3 hover:bg-indigo-500/10 transition-colors text-sm"
                  ...
                  <button
                    ...
                    className="w-full flex items-center gap-3 rounded-xl px-4 py-3 hover:bg-red-500/10 transition-colors group"
                    style={{ background: "var(--glass-bg)", border: "1px solid var(--glass-border)" }}
                  >
                    <Trash2 size={16} style={{ color: "var(--text-muted)" }} className="group-hover:text-red-400" />
                    <div className="text-left">
                      <p className="text-sm group-hover:text-red-300" style={{ color: "var(--foreground)" }}>Clear Chat History</p>
                      <p className="text-xs" style={{ color: "var(--text-muted)" }}>Delete all saved conversations</p>
                    </div>
                  </button>
                </div>
              </div>
              ...
              <div>
                ...
                >
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <p className="text-sm font-medium" style={{ color: "var(--foreground)" }}>Laila AI Assistant</p>
